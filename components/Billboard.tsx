...
const Billboard = () => {
   ...
   return (
      <div className='relative lg:h-[56.25vw]'>
         <video
            className='w-full h-screen lg:h-[56.25vw] object-cover brightness-[60%]'
            autoPlay
            muted
            loop
         ...
         <div className='absolute top-[70%] md:top-[40%] ml-4 md:ml-16'>
            ...
            <div className='flex items-center mt-3 md:mt-4 lg:mt-8 gap-3'>
               <button className='bg-white text-white bg-opacity-30 rounded-md py-2 px-2 md:px-4 w-auto text-xs lg:text-lg font-semibold hover:bg-opacity-20 flex items-center transition'>
